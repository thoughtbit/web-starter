...
const InternalEchartCore: React.ForwardRefRenderFunction<EchartCoreRef, EchartCoreProps> = (props, ref) => {
  ...
  React.useImperativeHandle(ref, () => ({
    ...
    echarts_native: echartCoreRef.current,
  }));
...
export const EchartCore = React.forwardRef<EchartCoreRef, EchartCoreProps>(InternalEchartCore);
