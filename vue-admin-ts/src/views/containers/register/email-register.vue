      ...
      <div class="box-bd">
        <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form" label-position="left">
          ...
          <el-form-item prop="password">
            <el-tooltip class="item" effect="dark" placement="top-start">
              <template slot="content">
                长度最好为6~20个字符<br> 字母/数字以及标点符号至少包含2种<br>不允许有空格或中文字符
              </template>
              <el-input
                  clearable
                  ref="password"
          ...
          <div class="register-action">
            ...
            >{{$t('register.sumbitBtn')}}</el-button>
  ...
  export default class Register extends Vue {
    ...
    private registerRules = <User>{
      ...
      password: [
        ...
        { min: 6, message: '登录密码长度最少为6位', trigger: 'blur' }
      ],
      repassword: [
        { required: true, trigger: "blur",  validator: this.validateRePassword },
        { min: 6, message: '确认密码长度最少为6位', trigger: 'blur' }
      ],
      ...
      isAgree: [
        { required: true, trigger: "change", validator: this.validateAgree },
      ]
    };
    ...
    private handleRegister(): void {
      ...
      this.$refs.registerForm.validate((valid) => {
        if (valid) {
          this.loading = true;
          SERVICE["signup"](this.registerForm).then(() => {
